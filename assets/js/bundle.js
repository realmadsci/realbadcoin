...
var secp = _interopRequireWildcard(_secp256k);
...
_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var privateKey, message, messageHash, publicKey, signature, isSigned, signatureE, signatureM, hex, rpub, rsignature, risSigned;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          isSigned = secp.verify(signature, messageHash, publicKey); // Sigs with improved security (see README)
        ...
        case 15:
          signatureM = _context.sent;
          // If you need hex strings
          hex = secp.utils.bytesToHex;
          console.log(hex(publicKey)); // Supports Schnorr signatures

          rpub = secp.schnorr.getPublicKey(privateKey);
          _context.next = 21;
          return secp.schnorr.sign(message, privateKey);

        case 21:
          rsignature = _context.sent;
          _context.next = 24;
          return secp.schnorr.verify(rsignature, message, rpub);

        case 24:
          risSigned = _context.sent;
